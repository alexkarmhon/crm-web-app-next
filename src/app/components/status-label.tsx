...
const StatusLabel = ({ status, disabled }: StatusLabelProps) => {
  return (
    <div
      className={clsx(
        'inline-flex items-center py-0.5 px-2 sm:py-1 sm:px-3.5 rounded-3xl text-xs sm:text-sm font-medium',
    ...
    >
      <div className="w-1 h-1 mr-0.5 sm:mr-2 rounded-full bg-current" />
